          ...
          >
            <div className="p-6">
              ...
              <Button
                ...
                className="w-full bg-white hover:bg-gray-200 text-black mb-6"
              >
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              What do you want to
              <span className="text-foreground block">explore today?</span>
            </motion.h1>
            ...
            <form onSubmit={handleSubmit}>
              <div className="relative">
                <Input
                  ...
                  className="w-full h-16 text-lg px-6 pr-16 bg-card border-2 border-border focus:border-foreground rounded-2xl shadow-lg font-[var(--font-body)]"
                  autoFocus={!isGuest}
                />
                <Button
                  type="submit"
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-white text-black hover:bg-gray-200 rounded-xl"
                >
