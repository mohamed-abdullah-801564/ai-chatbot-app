            ...
            <AnimatePresence>
              {messages.map((message) => (
                ...
                >
                  ...
                  <Card
                    className={`max-w-[70%] border ${
                      message.sender === "user" ? "bg-blue-600 text-white border-blue-600" : "bg-white border-gray-200"
                    }`}
                  >
                    <div className="p-4">
                      <p
                        className={`text-sm leading-relaxed whitespace-pre-wrap break-words font-[var(--font-body)] ${
                    ...
                    {Object.entries(languageConfig).map(([key, config]) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 hover:bg-gray-50 transition-colors first:rounded-t-lg last:rounded-b-lg ${
                          selectedLanguage === key ? "bg-blue-50 text-blue-700" : "text-gray-700"
                        }`}
                      >
                        {config.label}
                      </button>
